...
const Dashboard: React.FC = () => {
  ...
  const [repositories, setRepositories] = useState<Repository[]>(() => {
    const storageRepositories = localStorage.getItem('@GithuberExplorer:repositories');
  ...
  useEffect(() => {
    localStorage.setItem('@GithuberExplorer:repositories', JSON.stringify(repositories));
  }, [repositories]);
